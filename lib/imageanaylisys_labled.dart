...
class ImageAnalysisLabledScreen extends StatefulWidget {
  @override
  _ImageAnalysisLabledScreenState createState() =>
      _ImageAnalysisLabledScreenState();
}

class _ImageAnalysisLabledScreenState extends State<ImageAnalysisLabledScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Image Analysis Labled',
              style: TextStyle(
                fontSize: 0.04 * sw,
